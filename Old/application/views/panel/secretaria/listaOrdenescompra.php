<?php /** @var array $ordenescompra */?>
    ...
    <div class="panel-heading">
        ...
        <table class="table table-warning table-hover mb30" id="table1">
                ...
                <tr class="odd gradeX">
                    <td style=""> <?php echo $ordencompra->id_ordencompra ?> </td>
                    <td style="width: 35%"> <?php echo $ordencompra->desc_ordencompra ?> </td>
                    <td style=""> <?php echo $ordencompra->monto_ordencompra ?> </td>
                    <td style=""> <?php echo $ordencompra->fecha_ordencompra ?> </td>
                    <td style=""> <?php echo $ordencompra->id_proveedor ?> </td>
                    <td style=""> <?php echo $ordencompra->id_proyecto ?> </td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu pull-right">
                                <li><a href="<?php echo base_url() ?>index.php/compras/ver/<?php echo $ordencompra->id_ordencompra ?>">Ver Orden</a></li>
                                <li><a data-toggle="modal" data-target="#llamadaCliente">Llamada al cliente</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo base_url() ?>index.php/compras/editar/<?php echo $ordencompra->id_ordencompra ?>">Editar</a></li>
                                <li><a href="<?php echo base_url() ?>index.php/compras/eliminar/<?php echo $ordencompra->id_ordencompra ?>">Eliminar</a></li>
