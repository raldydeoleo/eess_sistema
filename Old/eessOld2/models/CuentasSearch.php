 ...
 */
class CuentasSearch extends Compras
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_compra', 'id_proveedor', 'id_proyecto','cantidad_compra', 'precio_compra'], 'integer'],

            [['desc_compra', 'unidad_compra', 'fecha_compra', 'vencimiento_compra','hora_compra'],  'safe'],
        ];
    }
