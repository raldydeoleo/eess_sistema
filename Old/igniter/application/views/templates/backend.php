        ...
        <div class="leftpanelinner">
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket ">
                ...
                <li  class="nav-parent"><a href="<?php echo base_url() ?>citas/citasAgendadasSecretaria"><i class="fa fa-user"></i> <span>Clientes</span></a>
                         <ul class="children" >
                            <li><a href="<?=base_url()?>index.php/clientes/seguimientoClientes">Ver Clientes</a></li>
                            <li><a href="<?=base_url()?>index.php/clientes/nuevo_cliente">Registrar Cliente</a></li>
                            <li><a href="<?=base_url()?>index.php/citas/crearCliente">Crear Cliente</a></li>
                 ...
                 <li class="nav-parent"><a href="<?php echo base_url() ?>citas/citasAgendadasSecretaria"><i class="fa fa-user"></i> <span>Empleados</span></a>
                                ...
                                <ul class="children">
                                    <li><a href="<?=base_url()?>index.php/empleados/seguimientoEmpleados">Ver Empleados</a></li>
                                    <li><a href="<?=base_url()?>index.php/citas/crearEmpleado">Crear Empleado</a></li>
                                    <li><a href="<?php echo base_url() ?>index.php/ordenes_trabajo/seguimientoordenTrabajo">Sistema de Ponche</a></li>
                 ...
                 <li class="nav-parent"><a href="<?php echo base_url()?>citas/agendarCita"><i class="fa fa-user"></i> <span>Proveedores</span></a>
                            <ul class="children">
                                <li><a href="<?=base_url()?>index.php/proveedores/seguimientoProveedores">Ver Proveedores</a></li>
                                <li><a href="<?=base_url()?>index.php/proveedores/nuevo_proveedor">Registrar Proveedor</a></li>
                                <li><a href="<?=base_url()?>index.php/citas/crearProveedor">Crear Proveedor</a></li>
                            </ul>
                 </li>
                ...
                <li class="nav-parent"><a href="<?=base_url() ?>#"><i class="fa fa-bell"></i> <span>Proyectos</span></a>
                    <ul class="children">
                        <li><a href="<?php echo base_url() ?>index.php/citas/listaProyectos">Proyectos Activos</a></li>
                        <li><a href="<?php echo base_url() ?>index.php/proyectos/seguimientoProyectos">Lista Proyectos</a></li>
                        <li><a href="<?php echo base_url() ?>index.php/citas/crearProyecto">Crear Proyecto</a></li>
                        <li><a href="<?php echo base_url() ?>index.php/proyectos/nuevo_proyecto">Registrar Proyecto</a></li>
                        <li><a href="<?php echo base_url() ?>index.php/Ordenes_trabajo/gastosDelproyecto">Balance Proyectos</a></li>
                    </ul>
                </li>

                <li  class="nav-parent"><a href="<?php echo base_url()?>inspeccion/inspeccion"><i class="fa fa-bell"></i> <span>Compras</span></a>
                    <ul class="children">
                        <li><a href="<?=base_url() ?>index.php/compras/listaCompras">Todas las compras</a></li>
                        <li><a href="<?=base_url() ?>index.php/compras/listaOrdenesCompra">Todas las Ordenes</a></li>
