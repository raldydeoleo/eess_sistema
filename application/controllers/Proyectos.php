...
class Proyectos extends BS_Controller {
     ...
     * Vista Individual.
     */
    public function gastosDelproyecto($id_proyecto){
        $this->load->model('proyectos_model');
        $detalle_proyecto = $this->proyectos_model->obtener_detalles_proyecto($id_proyecto);
        $this->asignarDatosVista('detalle_proyecto', $detalle_proyecto);
        $this->mostrarVista('panel/controlista/gastosDelproyecto');
    }

    /**
     * @author: Raldy De Oleo
     * Muestra detalles especificos del Asociado seleccionado en un momento dado.
     * Vista Individual.
     */
    public function gastosDelasociado($id_asociado){
        $this->load->model('proyectos_model');
        $detalle_asociado = $this->proyectos_model->obtener_detalles_asociado($id_asociado);
        $this->asignarDatosVista('detalle_asociado', $detalle_asociado);
        $this->mostrarVista('panel/controlista/gastosDelasociado');
    }
