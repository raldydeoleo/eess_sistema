                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu pull-right">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo base_url() ?>index.php/compras/editar/<?php echo $nominaempleados->id_empleado ?>">Imprimir</a></li>
                                <li><a href="<?php echo base_url() ?>#<?php echo $nominaempleados->id_empleado ?>">Enviar por email</a></li>
                                 <li><a href="<?php echo base_url() ?>index.php/empleados/genera_nomina/<?php echo $nominaempleados->id_empleado ?>">Genera Nomina</a></li>
