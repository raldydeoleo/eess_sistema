                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul role="menu" class="dropdown-menu pull-right">
                                        ...
                                        <li><a href="<?php echo base_url() ?>index.php/proyectos/gastosDelproyecto/<?php echo $proyecto->id_proyecto ?>">Detalles del Proyecto</a></li>
                                        <li><a data-toggle="modal" data-target="#llamadaCliente">Llamada al cliente</a></li>
                                        <li class="divider"></li>
                                        <li><a href="<?php echo base_url() ?>index.php/proyectos/<?php echo $proyecto->id_proyecto ?>">Editar</a></li>
