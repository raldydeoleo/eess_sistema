      ...
      <div class="panel-body" >
          ...
          <div class="col-md-12">
                  ...
                  <div class="people-item">
                      <div class="media">
                          ...
                          <div class="media-body">
                               ...
                               <div class="text-muted"><i class="fa fa-gear"></i> Cedula: <?php  echo $cedula_empleado; ?></div>
              ...
              <div class="col-md-1">
                  ...
                  <input type="text" name="he_empleado" id="he_empleado" class="form-control"  value="<?php  /** echo $he_empleado; */?>" />
              </div>
              <div class="col-md-2">
            ...
            <div class="col-md-12 right">
                <div class="panel panel-default">
                    ...
                    <div class="form-group">
                        <div class="col-md-1">
                            <label> AFP </label>
                            <input type="text" name="afp_empleado" id="afp" class="form-control"  required="required" value="<?php /**  echo $afp_empleado; */?>" />
                        </div>
                        <div class="col-md-1">
                            <label> ARS </label>
                            <input type="text" name="ars_empleado" id="ars" class="form-control"  required="required" value="<?php /** echo $ars_empleado; */ ?>" />
                        </div>
                        ...
                        <div class="col-md-2">
                            <label> ISR </label>
                            <input type="text" name="isr_empleado" id="prestamo" class="form-control" id="isr_empleado" onkeyup="sumar_deducciones()" value="" />
                        </div>
...
<!-- INICIO DE CODIGO COMBOS PARA SELECCIONAR PROYECTO Y ASOCIADO -->
            ...
            <script type="text/javascript">
                ...
                function percepciones(){
                    var valor1=verificar("he_empleado");
                    var valor2=verificar("comsion_empleado");
                    //var valor3=verificar("sueldo_bruto");

                    // realizamos la suma de los valores y los ponemos en la casilla del
                    // formulario que contiene el otras_percepciones.
                    document.getElementById("total_percepcion").value=parseFloat(valor1)+parseFloat(valor2);
                }

                function sumar_deducciones(){
                    var valor1=verificar("afp");
                    var valor2=verificar("ars");
                    ...
                    document.getElementById("sueldo_neto").value=parseFloat(valor4)-(parseFloat(valor1)+parseFloat(valor2)+parseFloat(valor3));
                }
                ...
                function sumar_percepciones()
                {
                    ...
                    // realizamos la suma de los valores y los ponemos en la casilla del
                    // formulario que contiene el sueldo bruto.
                    document.getElementById("sueldo_bruto").value=parseFloat(valor1)+parseFloat(valor2)+parseFloat(valor3);
                    document.getElementById("total_percepcion").value=parseFloat(valor2)+parseFloat(valor3);
                   // document.getElementById("total_ganado").value=parseFloat(valor4)+parseFloat(valor5);
                }

                function total_ganado()
                {

                    var valor1=verificar("total_otras_perc");
                    var valor2=verificar("sueldo_bruto");

                    document.getElementById("total_ganado").value=parseFloat(valor1)+parseFloat(valor2);
                }
