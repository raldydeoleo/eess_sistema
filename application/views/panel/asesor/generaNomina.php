            ...
            <div class="col-md-2">
              ...
              <div class="table-responsive">
                      <table class="table table-info table-hover" id="table1">
                          ...
                          <tbody>
                          <tr>                                                       
                        <td><a class="btn btn-danger" href="<?php echo base_url() ?>index.php/empleados/generar_nomina">Cancelar</a></td>
                        <td><input type="submit"  class="btn btn-success" value="Generar"  /></td>
                        <td><a class="btn btn-primary" href="<?php echo base_url() ?>index.php/pdfs/pdf_nomina/">Imprimir</a></td>
