            ...
            <div class="row">
                <div class="col-sm-12"><center> <div> <a class="btn btn-info" href="<?php echo base_url() ?>index.php/compras/listaOrdenesCompra"> Volver atrás </a>
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <center><div> <a class="btn btn-info" href="<?php echo base_url() ?>index.php/pdf/genera_pdf/<?php echo $id; ?>">PDF Orden </a> </div></center>

                    </div> </td>
                        <td>
                    <div class="col-sm-6 ">
                        <center><div> <a class="btn btn-info" href="<?php echo base_url() ?>index.php/pdfs/index"> PDF Ordenes </a> </div></center>
                    </div></td>
                                    ...
                                    <form method="post" action="<?php echo base_url().'index.php/welcome/do_upload' ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="panel- panel-default widget-photoday">
                                                    <div class="panel-body">
                                                        <img alt="documento anexado a orden" src="<?=base_url()?>uploads/test.jpg" width="800" height="300" class="media-object">
                                                    </div>
