<?php /** @var array $detalle_proyecto */?>


<div class="panel panel-default">
    <div class="panel-heading">
        <center><h2 class="panel-title">Detalle del Proyecto</h2></center>
    ...
    <div class="panel-body panel-body-nopadding">
        ...
        <form class="form-horizontal form-bordered">
            ...
            <div class="form-group">
                <div class="col-md-6">
                <label class="col-sm-3 control-label" for="readonlyinput">Cliente:</label>
                <div class="col-sm-6">
                    <h4 class="dark"></h4>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-sm-6">
                        <h4 class="dark"> <?php echo $detalle_proyecto->id_proyecto; ?> </h4>
                    </div>
               </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-info table-hover" id="table1">
                            ...
                            $sql = "SELECT * FROM percepciones WHERE id_proyecto =" . $detalle_proyecto->id_proyecto;
                ...
                <div class="col-md-6">
                    ...
                    <label class="col-sm-3 control-label" for="readonlyinput">Balance:</label>
                    <div class="col-sm-9">
                        <ul>
                            <li><h4 class="dark">Total: RD$2,200,000.00</<h4 class="dark"></li>
                            <li><h4 class="dark">Ajustes: RD$200,000.00</<h4 class="dark"></li>
                            <li><h4 class="dark">Abonado : RD$2,000,000.00</h4></li>
                            <li><h4 class="dark">Resta : RD$400,000.00</h4></li>
                        </ul>
                    </div>
                </div>
                </div>
