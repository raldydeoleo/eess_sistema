<?php /** @var array $ordenesporasociado */?>
    ...
    <div class="panel-heading">
        <h4 class="panel-title">Lista de ordenes de compra por asociado</h4>
            <div class="table-responsive">
                <?php if (count($ordenesporasociado)): ?>
        <table class="table table-warning table-hover mb30" id="table1">
                ...
                <?php foreach($ordenesporasociado as $ordenesasociado): ?>
                <tr class="odd gradeX">
                    <td style=""> <?php echo $ordenesasociado->numero_ordencompra ?> </td>
                    <td style=""> <?php echo $ordenesasociado->desc_ordencompra ?> </td>
                    <td style=""> <?php echo $ordenesasociado->total_ordencompra ?> </td>
                    <td style=""> <?php echo $ordenesasociado->fecha_ordencompra ?> </td>
                    <td style=""> <?php echo $ordenesasociado->fecha_vence ?> </td>
                    <td style=""> <?php echo $ordenesasociado->id_proveedor ?> </td>
                    <td style=""> <?php echo $ordenesasociado->id_proyecto ?> </td>
                    <td style=""> <?php echo $ordenesasociado->id_asociado ?> </td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu pull-right">
                                <li><a href="<?php echo base_url() ?>index.php/compras/verOrden/<?php echo $ordenesasociado->id_ordencompra ?>">Ver Orden</a></li>
                                <li><a data-toggle="modal" data-target="#llamadaCliente">Llamada al cliente</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo base_url() ?>index.php/compras/editar/<?php echo $ordenesasociado->id_ordencompra ?>">Editar</a></li>
                                <li><a href="<?php echo base_url() ?>#<?php echo $ordenesasociado->id_ordencompra ?>">Desactivar</a></li>
