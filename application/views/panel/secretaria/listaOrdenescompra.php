<?php /** @var array $ordenescompra */?>
    ...
    <div class="panel-heading">
        ...
        <table class="table table-warning table-hover mb30" id="table1">
                ...
                <tr class="odd gradeX">
                    <td style=""> <?php echo $ordencompra->numero_ordencompra ?> </td>
                    <td style=""> <?php echo $ordencompra->desc_ordencompra ?> </td>
                    <td style=""> <?php echo $ordencompra->total_ordencompra ?> </td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu pull-right">
                                <li><a href="<?php echo base_url() ?>index.php/compras/verOrden/<?php echo $ordencompra->id_ordencompra ?>">Ver Orden</a></li>
                                ...
                                <li><a href="<?php echo base_url() ?>#<?php echo $ordencompra->id_ordencompra ?>">Desactivar</a></li>
