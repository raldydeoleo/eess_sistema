<?php /** @var array $ordenesporproveedor */?>



    <div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">Lista de ordenes de compra por proveedor</h4>
            <div class="table-responsive">
                <?php if (count($ordenesporproveedor)): ?>
        <table class="table table-warning table-hover mb30" id="table1">
                ...
                <?php foreach($ordenesporproveedor as $ordenesproveedor): ?>
                <tr class="odd gradeX">
                    <td style=""> <?php echo $ordenesproveedor->numero_ordencompra ?> </td>
                    <td style=""> <?php echo $ordenesproveedor->desc_ordencompra ?> </td>
                    <td style=""> <?php echo $ordenesproveedor->total_ordencompra ?> </td>
                    <td style=""> <?php echo $ordenesproveedor->fecha_ordencompra ?> </td>
                    <td style=""> <?php echo $ordenesproveedor->fecha_vence ?> </td>
                    <td style=""> <?php echo $ordenesproveedor->id_proveedor ?> </td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu pull-right">
                                <li><a href="<?php echo base_url() ?>index.php/compras/verOrden/<?php echo $ordenesproveedor->id_ordencompra ?>">Ver Orden</a></li>
                                <li><a data-toggle="modal" data-target="#llamadaCliente">Llamada al cliente</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo base_url() ?>index.php/compras/editar/<?php echo $ordenesproveedor->id_ordencompra ?>">Editar</a></li>
                                <li><a href="<?php echo base_url() ?>#<?php echo $ordenesproveedor->id_ordencompra ?>">Desactivar</a></li>
