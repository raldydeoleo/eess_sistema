...
<div class="col-md-12">
        ...
        <table class="table table-warning table-hover mb30" id="table1">
                ...
                <tr class="odd gradeX">
                    ...
                    <td style=""> <?php echo $proveedor->cnombre_proveedor ?> </td>
                    <td style=""> <?php echo $proveedor->capellido_proveedor ?> </td>
                    <td style=""> <?php echo $proveedor->etelefono1_proveedor ?> </td>
                    <td style=""> <?php echo $proveedor->eemail1_proveedor ?> </td>
                    <td style=""> <?php echo $proveedor->edireccion_proveedor ?> </td>
                    <td>
                        <div class="btn-group">
