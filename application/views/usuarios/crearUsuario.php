    ...
    <div class="panel-body">
     <div class="col-md-12">
        <div class="col-md-12">
            ...
            <?=form_open(base_url().'index.php/usuarios/insertar_usuario');
...
?>
            ...
            <form class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                    ...
                    <div> <a class="btn btn-info" href="<?php echo base_url() ?>index.php/usuarios/listaUsuarios"> Volver atrás </a> </div>
        </div>
                </div>
